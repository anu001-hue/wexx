...
import { User, Interview } from "@/lib/schema";
...
function DashboardPage() {
  ...
  const { data: interviews, loading: interviewsLoading } = useApi(() => interviewsApi.getAll());
  const { mutate: updateStatus } = useMutation((params: { id: string; status: string }) => 
  ...
  if (usersLoading || interviewsLoading) return <LoaderUI />;
